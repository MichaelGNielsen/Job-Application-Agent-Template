...
- Ledet ekspeditioner til fjerntliggende egne som Tibet, Congo og det ydre rum (første menneske på månen).
- Ekspert i at infiltrere kriminelle netværk og afdække politisk korruption på højeste niveau.
- Dokumenteret videnskabelige opdagelser og arkæologiske fund af global betydning.

**Freelance Konsulent for Interpol & Lokale Politistyrker**
- Bistået med opklaring af adskillige højtprofilerede sager om forfalskning, kidnapning og sabotage.
- Tæt samarbejde med Dupond og Dupont (selvom deres bidrag ofte er af mere teoretisk karakter).
...
- Syldavisk & Bordurisk: Flydende.
- Dansk: God forståelse (pga. mine mange danske læsere).
